...
public class PersonalPlan extends AIModel
{
    ...
    //Constructor
    public PersonalPlan(String modelName, int contextWindowSize, float price, int modelParameterCount, int promptsRemaining)
    {
    ...
    public String purchaseAdditionPrompts(int extraPrompts)
    {
        if(extraPrompts < 0)
        {
